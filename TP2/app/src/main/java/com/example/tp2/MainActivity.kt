...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, LocationListener, OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        users.add(User("User 4", "user4@test.com"))
        users.add(User("User 5", "user5@test.com"))
        users.add(User("User 6", "user6@test.com"))
        users.add(User("User 7", "user7@test.com"))
        users.add(User("User 8", "user8@test.com"))
        users.add(User("User 9", "user9@test.com"))
        users.add(User("User 10", "user10@test.com"))
        users.add(User("User 11", "user11@test.com"))
        users.add(User("User 12", "user12@test.com"))
        users.add(User("User 13", "user13@test.com"))
        users.add(User("User 14", "user14@test.com"))
        users.add(User("User 15", "user15@test.com"))
